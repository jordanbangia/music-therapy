...
urlpatterns = [
    ...
    url(r'^(?P<user_id>[0-9]+)/submit_socialassess/$',
        views.save_social_assess, name="save_socialassessment"),
    url(r'^(?P<user_id>[0-9]+)/submit_socialgoals/$',
        views.save_social_goals, name="save_socialgoals"),
