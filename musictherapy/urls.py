...
urlpatterns = [
    ...
    url(r'^(?P<user_id>[0-9]+)/submit_musicassess/$',
        views.save_music_assess, name="save_musicassessment"),
    url(r'^(?P<user_id>[0-9]+)/submit_musicgoals/$',
        views.save_music_goals, name="save_musicgoals"),
