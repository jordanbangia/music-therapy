...
urlpatterns = [
    ...
    url(r'^musictherapy/(?P<user_id>[0-9]+)/submit_measurables/$', views.save_measurables, name="save_measurables"),
    url(r'^musictherapy/(?P<user_id>[0-9]+)/submit_goalmeasurables/$', views.save_goalmeasurables, name="save_goalmeasurables"),
